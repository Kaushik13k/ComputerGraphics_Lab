...
float grid1[4][4][3] = {
	...
	{ { -300, 300, 0 }, { -250, 300, 0 }, { -50, 300, 0 }, { 40, 300, 0 } }
};
float grid2[4][4][3] = {
...
float grid3[4][4][3] = {
	{ { -300, 75, 0 }, { -250, 75, 0 }, { -50, 75, 0 }, { 40, 75, 0 } },
...
void display() {
	...
	glLineWidth(1);
	glPushMatrix();
	glTranslatef(-300, 320, 0);
	glutSolidSphere(10, 10, 2);
	glPopMatrix();
	glBegin(GL_QUADS);
	glColor3f(1, 0.5, 0);
	glVertex2f(-350, -300);
...
int main(int argc, char** argv) {
	...
	glutAddMenuEntry("yellow background", 2);
	glutAddMenuEntry("cyan background", 3);
